Public Class frmViewStus
    ...
    Private Sub frmViewBook_Shown(sender As Object, e As EventArgs) Handles MyBase.Load
        ' RUN A QUERY
        Access.ExecQuery("SELECT * FROM sinhVien ORDER BY hotensv ASC")
    ...
    Private Sub SearchBook(Name As String)
        ...
        Access.AddParam("@hotensv", "%" & Name & "%")
        Access.ExecQuery("SELECT * " &
                         "FROM sinhVien " &
                         "WHERE hotensv LIKE @hotensv")
